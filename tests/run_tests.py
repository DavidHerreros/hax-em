...
PROGRAMS = ["hetsiren", "zernike3deep", "estimate_latent_covariances",
            "latent_space_deconvolution", "filter_latents", "flexconsensus",
            "decode_states_from_latents", "modart", "annotate_space",
